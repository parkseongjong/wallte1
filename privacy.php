...
<div style="font-size:21px; font-weight:bold; margin:40px 0;">
    TP3 Wallet 개인정보 보호정책
</div>

<div id="agree_more2_contents" class="none">
&lt;(주)한가족몰&gt;('https://cybertronchain.com/wallet')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br />
<br />
○ 본 방침은부터 2019년 7월 25일부터 시행됩니다.<br />
 <br />
1. 개인정보의 처리 목적 &lt;(주)한가족몰&gt;('https://cybertronchain.com/wallet')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.<br />
가. 홈페이지 회원가입 및 관리<br />
