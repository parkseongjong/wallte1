...
<?
    ...
    if ( $req_tx == "cert" )
    {
        ...
        $sbParam .= "<input type='hidden' name='kcp_cert_lib_ver' value='" . $ct_cert->get_kcp_lib_ver( $g_conf_home_dir ) . "'/>";// ENC1(TEST용)
		 //$sbParam .= "<input type='hidden' name='kcp_cert_lib_ver' value='" . $ct_cert->get_kcp_lib_ver() . "'/>";
    }
	$_SESSION['auth_re'] = '';
	$_SESSION['auth_re_r'] = '';
        ...
        <script type="text/javascript">
            ...
            function cert_page()
            {
				...
				else if ( frm.req_tx.value == "cert" )
                {
                    ...
                    if( ( navigator.userAgent.indexOf("Android") > - 1 || navigator.userAgent.indexOf("iPhone") > - 1 || navigator.userAgent.indexOf("android-web-view") > - 1 ) ) // 스마트폰인 경우
                    {
