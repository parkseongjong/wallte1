			...
			<div class="panel-body">
              ...
              <select name="getlang" onChange="changeLanguage(this);">
				...
				<div class="form-group">
					...
					<input type="password" id="psw"  pattern=".{6,}" title="Must contain at least 6 or more characters" name="passwd" class="form-control" required="required" >
				</div>
				
				<div class="form-group">
					<label class="control-label"><?php echo !empty($langArr['confirm_password']) ? $langArr['confirm_password'] : "Confirm Password"; ?></label>
					<input type="password" id="confirm_psw"  pattern=".{6,}" title="Must contain at least 6 or more characters" name="cofirm_passwd" class="form-control" required="required">
				</div>
				<div id="message">
