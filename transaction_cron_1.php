...
*/			
			...
			echo "\n";
			echo $ethAmount."   ".$ctcAmountToSend."   ".$getExchangePrice   ;
			
			echo "\n";
			echo $adminAccountWalletAddress."   ".$toUserAccount   ;
				...
				if($registerWith=="phone"){
					...
					$alertMsg = number_format((float)$actualAmountToSendWithoutDecimal,8)." CTC Token added to your account";
					 ...
					 $mailHtml = '<table style="background:#f6f6f6; width:100%;    height: 100vh;">
						...
						require '/var/www/html/wallet/sendgrid-php/vendor/autoload.php'; // If you're using Composer (recommended)
