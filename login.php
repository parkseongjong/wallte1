		...
		<option <?php echo ($_SESSION['lang']=='en') ? 'selected' : ""; ?> value="en">English</option>
				...
				<div class="tab-content">
					...
					<div id="phonebox" class="form-group tab-pane fade in active">
						...
						<input type="text" id="phone"  value="<?php echo isset($_COOKIE['phone']) ? $_COOKIE['phone'] : ''; ?>" name="phone" class="form-control" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input type="password" id="psw"  name="passwd" value="<?php echo isset($_COOKIE['password']) ? $_COOKIE['password'] : ''; ?>" class="form-control" title="<?php echo $langArr['this_field_is_required']; ?>" required="required">
				</div>
				...
				<div style="margin: 10px;"><a  href="register_agree.php" class="loginField" ><?php echo !empty($langArr['register']) ? $langArr['register'] : "Register"; ?></a></div>
			    <div><a href="forgetpassword.php"><?php echo !empty($langArr['forgot_password']) ? $langArr['forgot_password'] : "Forgot Password ?"; ?></a></div>
				
				<a href="http://barrybarries.kr/" title="barrybarries" class="bb_link">
