...
class   C_CT_CLI
{
    ...
    {
        $hash_data = $this -> mf_exec( $home_dir . "/bin/64bit/ct_cli" ,
    ...
    {
        $ret_val = $this -> mf_exec( $home_dir . "/bin/64bit/ct_cli" ,
    ...
    {
        $dec_data = $this -> mf_exec( $home_dir . "/bin/64bit/ct_cli" ,
    ...
    {
        $ver_data = $this -> mf_exec( $home_dir . "/bin/64bit/ct_cli" ,
